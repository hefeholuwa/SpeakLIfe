    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex items-center justify-between">
                <h3 className="text-xl font-bold text-gray-800">Daily Declarations</h3>
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-2xl font-bold text-purple-900">
                                    {dailyContent.filter(c => c.date.startsWith(new Date().toISOString().slice(0, 7))).length}
                                </p>
                            </div>
