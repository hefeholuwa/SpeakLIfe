        ...
        <div className="min-h-screen bg-[#FDFCF8] text-gray-900 font-sans pb-24 md:pb-0">
            ...
            <aside className="hidden md:flex flex-col w-64 fixed inset-y-0 left-0 border-r border-gray-100 bg-white/50 backdrop-blur-xl z-30">
                <div className="p-8">
                    ...
                    <nav className="space-y-2">
                        ...
                        <button onClick={() => setActiveTab('bootcamps')} className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${activeTab === 'bootcamps' ? 'bg-gray-900 text-white shadow-lg shadow-gray-900/10' : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900'}`}>
                            <Calendar size={20} />
                            <span className="font-medium">Bootcamps</span>
                        </button>
                ...
                <div className="fixed inset-0 z-50 bg-white animate-fade-in">
                    <div className="p-6">
                        ...
                        <nav className="space-y-4">
                            ...
                            <button onClick={() => { setActiveTab('bootcamps'); setShowMobileMenu(false) }} className="w-full flex items-center gap-4 p-4 bg-gray-50 rounded-2xl font-bold text-gray-900">
                                <Calendar size={24} /> Bootcamps
                            </button>
            ...
            <main className="md:pl-64 min-h-screen">
                <div className="max-w-5xl mx-auto p-6 md:p-12">
                    ...
                    {activeTab === 'community' && (
                        <div className="animate-fade-in-up">
                            <CommunityChat onViewProfile={(uid) => {
